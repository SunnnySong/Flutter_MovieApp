...
abstract class $MovieCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, List<String> originCountry, String originalTitle});
}
...
class _$MovieImpl implements _Movie {
  ...
  @override
  String toString() {
    return 'Movie(id: $id, originCountry: $originCountry, originalTitle: $originalTitle)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id,
      const DeepCollectionEquality().hash(_originCountry), originalTitle);
...
abstract class _Movie implements Movie {
  const factory _Movie(
      ...
      required final List<String> originCountry,
      required final String originalTitle}) = _$MovieImpl;
